...
ผลลัพธ์นี้แสดง ผู้ป่วย 5 อันดับแรกที่ขาดนัดบ่อยที่สุด (missed)
ข้อมูลนี้ช่วยให้โรงพยาบาล ระบุและติดตามกลุ่มผู้ป่วยที่มีแนวโน้มขาดนัด ซึ่งสามารถใช้ในการวางแผนปรับปรุงบริการ, ส่ง SMS เตือน, หรือติดต่อเพื่อปรับตารางนัดให้เหมาะสม
